...
def create_app_ui():
    ...
    html.Br(),
    html.H1(children = 'Terrorism Analysis with Insights', id = 'main_title', style = {"textAlign" : "center",'backgroundColor' : 'black','color': 'white', 'border' : '5px solid black', 'border-radius' : 10, 'margin-left': 200, 'margin-right' : 200}),
    html.Br(),
...
def update_date(month_value, year_value):
    date_list = [x for x in range(1, 32)]
    options = []
    if month_value:
